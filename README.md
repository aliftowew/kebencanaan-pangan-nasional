...
- Skenario bencana historis sekali klik, 2004–2026: gempa besar (Aceh 2004, Yogyakarta 2006, Padang 2009, Lombok dan Palu 2018, Cianjur 2022, Laut Sulawesi Jun 2026, Flores NTT Agu 2026), banjir (Jabodetabek 2020, Kalsel 2021, Demak–Kudus 2024, banjir bandang Sumbar 2024, banjir-longsor Sumatra Des 2025 di dua klaster dampak), dan karhutla (Riau 2019, Kalteng dan Sumsel 2015) — titiknya perkiraan pusat wilayah terdampak, radiusnya usulan awal. Episentrum gempa 2026 dari rilis BMKG; wilayah terparah banjir Sumatra 2025 dari rekap BNPB/pemberitaan
...
1. **Titik SPPG bukan alamat persis.** Halaman publik BGN tidak memuat koordinat, jadi setiap SPPG diplot pada centroid kecamatannya (25.335 baris, 92,5%) atau centroid kab/kota (2.052 baris, 7,5%) bila nama kecamatan tidak cocok dengan gazetteer atau koordinat gazetteer-nya terbukti salah tempat. Cukup untuk perencanaan radius puluhan km; tidak cukup untuk routing lapangan. Kolom `presisi` menandai setiap baris.
2. **Koordinat gazetteer divalidasi terhadap poligon provinsi.** Gazetteer komunitas menempatkan 1.776 kecamatan bernama umum (SELONG, KEDIRI, TAMAN, PULAUPINANG, ...) di provinsi lain, bahkan di luar negeri (contoh: Kec. Pulaupinang, Lahat, sempat mendapat koordinat Pulau Pinang Malaysia). `01_match_kecamatan.py` memeriksa setiap titik terhadap poligon provinsinya: titik yang jatuh di dalam provinsi lain atau sangat jauh dari provinsinya diganti centroid kab/kota (10 di antaranya memakai rata-rata centroid kecamatan valid karena centroid kab-nya ikut salah). Kecamatan kepulauan yang tidak tercakup poligon provinsi sederhana (Kep. Seribu, pulau-pulau Sumenep, Natuna, Sitaro, Takabonerate) tetap diterima.
3. **Snapshot daftar SPPG.** Daftar diambil dari salinan komunitas halaman `bgn.go.id/operasional-sppg` (27.640 baris; 253 duplikat akibat pergeseran paginasi dihapus). File di-commit 26 Agustus 2026, tanggal pengambilannya tidak dinyatakan. Rekap resmi BGN per 8 Juni 2026 mencatat 29.991 unit; sejak Juni 2026 ada moratorium SPPG baru dan ribuan unit sempat disuspensi, jadi selisih angka wajar. Minta ekspor resmi BGN (yang memuat koordinat) untuk versi otoritatif.
4. **Jarak dalam simulasi adalah garis lurus (haversine)**, bukan waktu tempuh. Untuk kepulauan dan pegunungan, selisihnya bisa besar.
5. **Gudang BULOG belum terisi.** Tidak ada sumber publik dengan koordinat gudang; struktur nasional BULOG adalah 26 Kanwil, sekitar 101 Kancab, 30 Kancab Pembantu, sekitar 500 kompleks gudang milik (kapasitas 3 juta ton) dan 1.254 gudang filial sewa (2,69 juta ton per April 2026), plus 100 gudang baru yang sedang dibangun di 92 kab/kota. Isi `data/bulog_gudang.csv` dari data resmi BULOG lalu jalankan `02_build_map.py`.
6. Alamat Kanwil BULOG bersumber dari dokumen 2021; koordinatnya tingkat kota (kecuali Bali yang punya titik alamat). Verifikasi sebelum dipakai untuk routing.
